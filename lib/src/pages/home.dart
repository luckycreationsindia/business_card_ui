...
class _MyHomePageState extends State<MyHomePage> {
        ...
        if (snapshot.connectionState == ConnectionState.done) {
          if (snapshot.data != null) {
            ...
            return AnnotatedRegion<SystemUiOverlayStyle>(
              ...
              child: Title(
                title: '${customer.displayName} - Business Card',
                color: mainColor,
                child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CircleAvatar(
                                      radius: 10,
                                      backgroundImage: customer.profile !=
                                                  null &&
                                  ...
                                  customer.company != null &&
                                      ...
                                      : Container(),
                                  customer.sectors != null &&
                                          customer.sectors!.isNotEmpty
            ...
            return const Scaffold(
              body: Center(child: Text("Invalid Customer")),
            );
          }
        }
        return const Scaffold(
  ...
  Future<Customer> loadData() async {
    String id = Uri.base.queryParameters['id'] ?? "";
    Customer? customerData;
    if (id.isNotEmpty) {
      try {
        customerData = await CustomerRestClient(Consts.dio).loadCustomer(id);
        Provider.of<Customer>(context, listen: false).update(customerData);
      } catch (_) {}
    }
    return Future.value(customerData);
  }
}
